...
static Article make_article(const std::string& link,
...
TEST_CASE("DatabaseManager::AddArticle round-trips single quotes", "[db][integration][sql]") {
    ...
    Article art = make_article("https://arxiv.org/abs/2403.00001",
...
TEST_CASE("DatabaseManager::AddArticle round-trips curly braces", "[db][integration][sql]") {
    ...
    Article art = make_article("https://arxiv.org/abs/2403.00002",
...
TEST_CASE("DatabaseManager::AddArticle round-trips multi-byte UTF-8", "[db][integration][sql]") {
    ...
    Article art =
        make_article("https://arxiv.org/abs/2403.00003",
...
TEST_CASE("DatabaseManager::ToggleBookmark round-trips link with special chars",
          "[db][integration][sql]") {
    DatabaseManager db(":memory:");

    Article art = make_article(
        "https://arxiv.org/abs/it's-a-2403.00004", "Test Article", "Tester", "Abstract");
    db.AddArticle(art);
...
TEST_CASE("DatabaseManager::AddProject round-trips name with single quote",
          "[db][integration][sql]") {
    DatabaseManager db(":memory:");
...
TEST_CASE("DatabaseManager::AddProject round-trips name with curly braces",
          "[db][integration][sql]") {
    DatabaseManager db(":memory:");
...
TEST_CASE("DatabaseManager::RemoveProject with single-quote name removes cleanly",
          "[db][integration][sql]") {
    DatabaseManager db(":memory:");
...
TEST_CASE("DatabaseManager::LinkArticleToProject round-trips with special chars",
          "[db][integration][sql]") {
    DatabaseManager db(":memory:");

    Article art = make_article("https://arxiv.org/abs/2403.00005",
...
TEST_CASE("DatabaseManager::UnlinkArticleFromProject with special chars",
          "[db][integration][sql]") {
    DatabaseManager db(":memory:");

    Article art = make_article("https://arxiv.org/abs/2403.00006", "Title", "Author", "Abstract");
    db.AddArticle(art);
...
TEST_CASE("DatabaseManager::SetProjectParent round-trips parent with single quote",
          "[db][integration][sql]") {
    DatabaseManager db(":memory:");
...
TEST_CASE("DatabaseManager::SetRating round-trips link with single quote",
          "[db][integration][sql]") {
    DatabaseManager db(":memory:");

    Article art =
        make_article("https://arxiv.org/abs/O'Brien-2403.00007", "Title", "Author", "Abstract");
    db.AddArticle(art);
...
TEST_CASE("DatabaseManager::SetRating round-trips link with curly braces",
          "[db][integration][sql]") {
    DatabaseManager db(":memory:");

    Article art =
        make_article("https://arxiv.org/abs/{special}-2403.00008", "Title", "Author", "Abstract");
    db.AddArticle(art);
...
TEST_CASE("DatabaseManager::SetProjectNote round-trips note with single quote",
          "[db][integration][sql]") {
    DatabaseManager db(":memory:");

    Article art = make_article("https://arxiv.org/abs/2403.00009", "Title", "Author", "Abstract");
    db.AddArticle(art);
...
TEST_CASE("DatabaseManager::SetProjectNote round-trips note with curly braces and UTF-8",
          "[db][integration][sql]") {
    DatabaseManager db(":memory:");

    Article art = make_article("https://arxiv.org/abs/2403.00010", "Title", "Author", "Abstract");
    db.AddArticle(art);
...
TEST_CASE("DatabaseManager::SearchArticles with single-quote query", "[db][integration][sql]") {
    ...
    Article art1 = make_article("https://arxiv.org/abs/2403.00011",
                                "O'Brien's theorem revisited",
                                "O'Brien, Patrick",
                                "A study of O'Brien's original conjecture.");
    Article art2 = make_article("https://arxiv.org/abs/2403.00012",
                                "Unrelated paper",
                                "Smith, Alice",
...
TEST_CASE("DatabaseManager::GetProjectsForArticle with special-char link",
          "[db][integration][sql]") {
    DatabaseManager db(":memory:");

    Article art =
        make_article("https://arxiv.org/abs/it's-2403.00013", "Title", "Author", "Abstract");
    db.AddArticle(art);
